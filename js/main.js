;(function () {
	...
	// Set the date we're counting down to
		// var countDownDate = new Date("Jun 23, 2018 17:00:00").getTime();
	...
	var rsvpForm = function(){			
		$(document).ready(function() {
			...
			$(".rsvp-choice").change(function() {
			    $(".rsvp-choice").prop('checked', false);
			...
			$('form.rsvp-form').on('submit', function(e) {
				...
				if ($(".full-name").val().length == 0){
					...
					e.preventDefault();
					alert("Please select a checkbox to confirm if you are attending or not. Thank you.");
					return false;
				} else {
