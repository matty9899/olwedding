...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div class="qbootstrap-hero" data-section="home">
		...
		<div class="qbootstrap-cover text-center" style="background-image: url(images/home-header.png); background-position: center !important;">
			<div class="display-t">
	...
	<div class="schedule section" data-section="schedule">
		<div class="container">
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3 class="large">14:00</h3>
						<p>Ceremony at Foxhill Manor House<br>Please be seated by 13:30</p>
					</div>
				</div>
			</div>
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3 class="large">15:00</h3>
						<p>Photos outside of Foxhill Manor<br>(Weather permitting)</p>
					</div>
				</div>
			</div>
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3 class="large">16:00</h3>
						<p>Dinner, drinks and speeches</p>
					</div>
				</div>
			</div>
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3 class="large">19:00</h3>
						<p>Drinks, drinks, dancing, cake cutting,<br>and more drinks</p>
					</div>
				</div>
			</div>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/foxhill/WRD0013.jpg); background-position: bottom -100px center;"></div>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/foxhill/WRD9999.jpg);"></div>
