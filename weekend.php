...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div class="qbootstrap-hero" data-section="home">
		...
		<div class="qbootstrap-cover text-center" style="background-image: url(images/foxhill/WRD9815.jpg); background-position: center !important;">
			<div class="display-t">
		...
		<div class="container">
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3>Friday</h3>
						<p>Arrive Friday eve for a welcome<br>BBQ and drinks<br>at <span class="highlight">19:00</span></p>
					</div>
				</div>
			</div>
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3>Saturday</h3>
						<p>Arrive for wedding Ceremony.<br>and be seated<br>by <span class="highlight">1.30</span></p>

						<p>Dinner, drinks and speeches<br>at<span class="highlight">16.00</span></p>

						<p>Drinks, dancing, cake cutting,<br>and more drinks<br>by <span class="highlight">19.30</span></p>
					</div>
				</div>
			</div>
			...
			<div class="row animate-box schedule-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<h3>Sunday</h3>
						<p>Join us for farewell breakfast and<br>a drink at Foxhill Manor<br>at <span class="highlight">10.00</span></p>
					</div>
				</div>
			</div>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/foxhill/WRD9855.jpg); background-position:center;"></div>
	...
	<div class="section accommodation" data-section="accommodation">
		<div class="container">
			...
			<div class="row animate-box accommodation-item">
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="col-md-12 text-center">
						<div class="image">
						...
						<p>We would like you to stay with at Foxhill Manor with close friends and family members.</p>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/IMG_4091.jpg);"></div>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/foxhill/stone.jpg);"></div>
	...
	<div class="qbootstrap-bg bg-image" style="background-image: url(images/IMG_4096.jpg);"></div>
